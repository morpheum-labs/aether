...
- [ ] **Host import wiring** — define and implement WASM import namespaces for **`request.security`**, **`request.financial`**, and **`strategy.*`**, routed to oracle/feed **stubs** first, then real data paths.
